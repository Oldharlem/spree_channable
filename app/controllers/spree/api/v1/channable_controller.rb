class Spree::Api::V1::ChannableController < Spree::Api::BaseController
  ...
  def get_products
    @products = Spree::Product.distinct.active.includes([:option_types, :taxons, product_properties: :property, variants: [{option_values: :option_type}, :default_price, :images], master: [{option_values: :option_type}, :default_price, :images]])
  end
